...
//            ) )
        ...
        $SECURITY_SECTION->add_group( __( 'reCaptcha Api Keys', 'ajax-login-and-registration-modal-popup' ), 'recaptcha' )
            ...
            ->add_field( array(
                'slug'        => 'threshold',
                'name'        => __('Score threshold ', 'ajax-login-and-registration-modal-popup' ),
                'default'     => '0.5',
